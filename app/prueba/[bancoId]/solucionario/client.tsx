      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-3 pt-0">
            <div className="flex min-h-7 h-auto overflow-hidden rounded-md bg-slate-300/30 dark:bg-slate-700/30">
              {totalBien > 0 && (
                <div
                        ...
                        {opciones.map((opcion) => {
                          ...
                          return (
                            <div className="rounded-xl py-1" key={opcion.value}>
                              <div
                                className={`relative min-h-7 h-auto w-full overflow-hidden rounded-md bg-slate-300/30 dark:bg-slate-700/30 ${borderClass}`}
                              >
                                <div
                                ...
                                <div className="relative flex items-center justify-between gap-2 px-2 py-1.5">
                                  <span
                                    className={`font-semibold text-xs ${correcta
                                  ...
                                  <div className="flex shrink-0 items-center gap-1 text-right">
                                    ...
                                    {elegida && (
                                      <Badge variant="outline" className="h-4 px-1.5 py-0 text-[10px] border-gray-500 leading-none">
                                        Tu elección
                                      </Badge>
                                    )}
