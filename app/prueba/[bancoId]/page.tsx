...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: "Resolucion de banqueo con temporizador y registro de respuestas.",
  };
}
...
function normalizeAssets(_value: unknown): PreguntaAsset[] {
  return [];
}
