...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: "Resultados finales y estadisticas comparativas por pregunta.",
  };
}
      ...
      <div className="mx-auto container">
        ...
        <div className="mx-auto mt-4 flex w-full max-w-3xl flex-col items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <Button
              render={
                <Link href={`/mis-banqueos/${banco.id}/solucionario?intentoId=${intentoFinal.id}`} />
              }
            >
              Ver solucionario
            </Button>
            <Button variant="outline" render={<Link href="/mis-banqueos" />}>
          ...
          <div className="w-full space-y-4">
            ...
            <div className="grid grid-cols-1 divide-y bg-muted/5 md:grid-cols-2 md:divide-x md:divide-y-0">
              <div className="space-y-2 p-6">
                ...
                <div className="space-y-1">
                  ...
                  {areas.length === 0 && <span className="text-sm italic text-muted-foreground">No asignado</span>}
                </div>
              </div>
