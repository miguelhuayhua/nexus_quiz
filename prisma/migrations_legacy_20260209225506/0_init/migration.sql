...
-- CreateEnum
CREATE TYPE "EvaluacionTipo" AS ENUM ('SIMULACRO', 'OFICIAL');
...
-- CreateEnum
CREATE TYPE "SolucionKind" AS ENUM ('TEXT', 'NUMBER', 'CHOICE_SINGLE', 'CHOICE_MULTI', 'IMAGE');

-- CreateEnum
CREATE TYPE "Tabla" AS ENUM ('AUDITORIA', 'CATEGORIAS', 'USUARIOS_ESTUDIANTES', 'ESTUDIANTES', 'USUARIOS_ADMINISTRADORES', 'DOCENTE', 'CURSOS', 'CATEGORIAS_CURSOS', 'REVIEWS_CURSOS', 'EDICIONES_CURSOS', 'BENEFICIOS_CURSOS', 'OBJETIVOS_CURSOS', 'REQUISITOS_CURSOS', 'CLASES', 'MATERIALES', 'EXAMENES', 'CALIFICACIONES', 'INSCRIPCIONES', 'CERTIFICADOS', 'PRECIOS_CURSOS', 'COMPRAS', 'GRABACIONES', 'EVALUACIONES', 'EVALUACION_PREGUNTA', 'PAGOS_DOCENTE');
...
CREATE TABLE "evaluacionPreguntas" (
    ...
    CONSTRAINT "evaluacionPreguntas_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "evaluacionPreguntas_evaluacionId_orden_idx" ON "evaluacionPreguntas"("evaluacionId", "orden");

-- CreateIndex
CREATE INDEX "evaluacionPreguntas_preguntaId_idx" ON "evaluacionPreguntas"("preguntaId");

-- CreateIndex
CREATE UNIQUE INDEX "evaluacionPreguntas_evaluacionId_preguntaId_key" ON "evaluacionPreguntas"("evaluacionId", "preguntaId");
...
-- CreateIndex
CREATE UNIQUE INDEX "soluciones_preguntaId_key" ON "soluciones"("preguntaId");

-- CreateIndex
CREATE INDEX "soluciones_kind_idx" ON "soluciones"("kind");
...
-- AddForeignKey
ALTER TABLE "evaluacionPreguntas" ADD CONSTRAINT "evaluacionPreguntas_evaluacionId_fkey" FOREIGN KEY ("evaluacionId") REFERENCES "evaluaciones"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "evaluacionPreguntas" ADD CONSTRAINT "evaluacionPreguntas_preguntaId_fkey" FOREIGN KEY ("preguntaId") REFERENCES "preguntas"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "soluciones" ADD CONSTRAINT "soluciones_preguntaId_fkey" FOREIGN KEY ("preguntaId") REFERENCES "preguntas"("id") ON DELETE CASCADE ON UPDATE CASCADE;
